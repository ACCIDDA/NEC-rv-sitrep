...
# Uses the CDC "Epidemic Trends and Rt" dataset.
...
# USER-PROVIDED summary bullets 
summary_bullets <- c(
    "The current COVID epidemic trend is **declining** for Arizona and Colorado, **likely declinging** for New Mexico, and **not changing** for Utah. The weekly percentage of ED visits diagnosed with COVID was **very low** for Arizona, Colorado, New Mexico, and Utah. (Trend assessments based on data reported through 2/24/2026)",
  
  "The current flu epidemic trend is **declining** for Arizona and Utah and **not changing** for Colorado and New Mexico. The weekly percentage of ED visits diagnosed with influenza was **moderate** for Arizona, Colorado, and Utah and **low** for New Mexico. (Trend assessments based on data reported through 2/24/2026)",
  
    "The current RSV epidemic trend is **growing** for Colorado, **likely growing** for New Mexico, and **not changing** for Arizona and Utah. The weekly percentage of ED visits diagnosed with RSV was **moderate** for Colorado, New Mexico, and Utah and **low** for Arizona. (Trend assessments based on data reported through 2/24/2026)"
)
# --------------------
...
if (knitr::is_html_output()) {
  cat('
<ul class="nav nav-pills justify-content-center disease-tabs" id="diseaseTabs" role="tablist">
')
...
<li class="nav-item" role="presentation">
  <button class="nav-link %s" id="%s-tab" data-bs-toggle="pill"
          data-bs-target="#%s" type="button" role="tab">
    %s
  </button>
</li>
', active, diseases_to_plot[i], diseases_to_plot[i], toupper(diseases_to_plot[i])))
}
...
for (i in seq_along(diseases_to_plot)) {
  ...
  cat(sprintf('<div class="tab-pane fade %s" id="%s" role="tabpanel">', active, diseases_to_plot[i]))

  # summary
  cat('<div class="cardish-summary">')
  cat(commonmark::markdown_html(summary_bullets[i]))
  cat('</div>')
