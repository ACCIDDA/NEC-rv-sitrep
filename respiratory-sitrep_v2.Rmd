...
---
title: "Respiratory Virus Situation Report (AZ, NM, UT) — `r format(Sys.Date(), '%B %d, %Y')`"
output:
  html_document:
    toc: true
    toc_depth: 2
...
summary_bullets <- c(
  "The current COVID epidemic trend is not changing for Arizona, is growing for New Mexico, and is not estimated for Utah. The weekly percentage of ED visits diagnosed with COVID is very low for Arizona, New Mexico, and Utah. Hospital admissions for COVID are currently decreasing in Arizona, increasing in New Mexico, and stable in Utah.",
  "The current flu epidemic trend is growing for Arizona and New Mexico but is not currently estimated for Utah. The weekly percentage of ED visits diagnosed with flu is very low for Arizona and New Mexico but is not currently estimated for Utah. Hospital admissions for flu are currently increasing in Arizona and New Mexico but stable in Utah.",
