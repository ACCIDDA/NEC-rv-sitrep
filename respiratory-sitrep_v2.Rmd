...
sc2_g1 <- ggplot(
  ...
  scale_linetype_manual(
    values = c("State" = "solid", "National" = "longdash"),
    guide = "none"
  ) +

  labs(
    title = "Adult (18+) COVID Vaccination Coverage — National + AZ/CO/NM/UT",
    x = "Week ending",
...
flu_g1 <- ggplot(
  ...
  labs(
    title = "Adult (18+) Flu Vaccination Coverage — National + AZ/CO/NM/UT",
    x = "Week ending",
    y = "Coverage (% Up-to-date)"
  ) +
  theme_minimal() +
...
rsv_g1 <- ggplot(
  ...
  labs(
    title = "Adults 50+ RSV Vaccination Coverage — National + AZ/CO/NM/UT",
    x = "Week ending",
    y = "Coverage (% Up-to-date)"
  ) +
  theme_minimal() +
