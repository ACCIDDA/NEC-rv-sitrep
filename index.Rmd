...
hub_date <- as.Date(floor_date(today, unit = "week", week_start = 7) - 1 + 7)
...
summary_bullets <- c(
    "The current COVID epidemic trend (based on data reported through 1/13/2026) is **declining** for Colorado, Arizona, and New Mexico and is not currently estimated for Utah. The weekly percentage of ED visits diagnosed with COVID was **low** for Colorado and New Mexico and **very low** for Arizona and Utah.",
  
  "The current flu epidemic trend (based on data reported through 1/13/2026) is **declining** for Colorado, and New Mexico, is **not changing** for Arizona, and is not currently estimated for Utah. The weekly percentage of ED visits diagnosed with flu was **high** for Colorado, **moderate** for New Mexico & Utah, and **low** for Arizona.",
  
    "The current RSV epidemic trend  (based on data reported through 1/13/2026) is **growing** for Colorado, **likely growing** for Arizona and New Mexico, and is not currently estimated for Utah. The weekly percentage of ED visits diagnosed with RSV was **low** for Arizona, Colorado, New Mexico, and Utah."
)
